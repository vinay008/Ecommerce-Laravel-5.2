          ...
          <div class="col-md-6 text-center" style=" margin-top:-1%;">            
              <div class="form-group col-md-12 ">
                ...
                <div class="col-md-8 col-md-push-0">
                  ...
                  <input type="file" class="filestyle" name="files[]" id="fileupload" data-buttonText="Upload" multiple="true" value="">
                  </div>
                </div>
              ...
              <div class="form-group col-md-6">
                <div class="col-md-6">
                  <button class="btn btn-success" type="submit" name="submit">Save Product</button>
                </div>
                <div class="col-md-6">
