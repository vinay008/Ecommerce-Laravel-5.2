    ...
    <div class="col-md-push-1  col-md-10 container-fluid">
      <div class="col-md-12 ">
        <div class="col-md-12  text-justify well well-lg" style="border:1px solid; border-radius:0px; padding-bottom:5%;">
          <div class="col-md-12">
            <label>
              <h3>Attribute/Add Attribute {{ $category_id }}</h3>
            </label><br/><br/>
          </div>
            ...
            <form class="form-horizontal" action="storeattr" method="POST">
              ...
              <div class="form-group col-md-12">
                ...
                <div class="col-md-7 col-md-pull-2">
                  <input id="atitle" name="attribute_name" placeholder="" class="form-control input-md" type="text">
                </div>
              </div>
              ...
              <!-- Multiple Radios (inline) -->
                   <button class="btn btn-success col-md-5" style="text-decoration:none;color: white;margin-top:8%;" type="submit" name="submit">Add
                   </button>
                </div>
